...
## Wise words
 'Doubt is the origen of wisdom' - Augustine of Hippo
[the link text ](https://wisdomquotes.com/words-of-wisdom/)

## my semester
|**Coures number**|_Course tittel_|Instructor name
|:------------|:------------|:--------------|
|**Data 2401**|_Data Science 1_| Dr. Katherin|
|**MATH2305** |_Discrete Mathematics_ | Dr. Jane |
|**CS 2331**|_Introdaction to Pyton_|Dr. Henderson|
